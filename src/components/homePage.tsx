...
const services = [
  const [showConsent, setShowConsent] = useState(false);
  {
    ...
    description:
      "WE CREATE personalized, all-encompassing financial plans that adapt to your goals, lifestyle, and life stages—from budgeting to investment, estate planning with precepts and Simplywills.",
    features: [
      <div key="1">
